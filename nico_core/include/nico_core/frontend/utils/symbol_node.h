#ifndef NICO_CORE_SYMBOL_NODE_H
#define NICO_CORE_SYMBOL_NODE_H
...
public:
    ...
    /**
     * @brief Returns the appropriate LLVM linkage type for this binding
     * entry based on its binding information.
     *
