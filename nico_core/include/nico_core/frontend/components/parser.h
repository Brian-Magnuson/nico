#ifndef NICO_CORE_PARSER_H
#define NICO_CORE_PARSER_H
...
class Parser {
     ...
     * represented by the target type (e.g., overflow), the error code will be
     * set to std::errc::result_out_of_range.
     *
