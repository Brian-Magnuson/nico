#ifndef NICO_CORE_GLOBAL_CHECKER_H
#define NICO_CORE_GLOBAL_CHECKER_H
...
class GlobalChecker : public Stmt::Visitor {
    ...
    // The annotation checker used for checking annotations.
...
#endif // NICO_CORE_GLOBAL_CHECKER_H
