#ifndef NICO_CORE_CODE_GENERATOR_H
#define NICO_CORE_CODE_GENERATOR_H
...
#include "nico_core/frontend/utils/control_stack.h"
...
class CodeGenerator : public Stmt::Visitor, public Expr::Visitor {
     ...
     * @param main_fn_name The name of the main function.
     */
...
#endif // NICO_CORE_CODE_GENERATOR_H
