#ifndef NICO_CORE_ERROR_CODE_H
#define NICO_CORE_ERROR_CODE_H
...
enum class Err {
    ...
    UnclosedGrouping,
    // A grouping token was found to close without an opening token.
    ClosingUnopenedGrouping,
