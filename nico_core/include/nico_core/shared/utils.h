#ifndef NICO_CORE_UTILS_H
#define NICO_CORE_UTILS_H
...
inline const char* RUNTIME_LIB_PATH = NICO_RT_LIB_PATH;

/**
 * @brief Prints out a message to stderr with source location information,
 * then aborts the program.
 *
 * In accordance with our code style, messages should be written using
 * sentence case and should end with a period.
 *
 ...
 * @param location The source location of the caller. Defaults to the
 * location of the call site. You probably should not set this parameter
 * manually.
