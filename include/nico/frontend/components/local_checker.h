...
class LocalChecker : public Stmt::Visitor {
    ...
    // /**
    //  * @brief Checks if the expression is a pointer and fully dereferences it
    //  if
    //  * it is.
    //  *
    ...
    //  *
    //  * If the expression is a raw pointer and is not within an unsafe
    //  context,
    //  * an error will be logged and nullptr will be returned.
    //  *
    //  * @param expr The expression to check. Should be type checked.
    //  * @return The fully dereferenced type of the expression, or nullptr if
    //  an
    //  * error occurred.
    //  */
    // std::shared_ptr<Type>
    ...
    //  * pointer type.
    //  * @param target_type The target type of the cast. Should be a pointer
    //  type.
    ...
    //  *
    //  * If the arguments match the parameters, this function returns a
    //  complete
    ...
    //  * @return A mapping of parameter names to argument expressions, or an
    //  empty
